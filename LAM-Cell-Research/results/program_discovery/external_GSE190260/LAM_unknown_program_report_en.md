# LAMCORE Unknown-State Program Discovery Report: GSE190260

> This report documents program-discovery candidates in GSE190260. It is not a completed independent-validation claim.

Run mode: `configured_full`. The configured full rank, seed, and donor-wise analysis parameters were used.

## Completed in this stage

- Input: 39979 cells and 33694 genes;
- Pools: high-confidence 1564, broad 7811, unrestricted guardrail 39979;
...
- `high_confidence`: selected rank=5, seed=0, factor stability=1.000.
- `broad_lam_like`: selected rank=6, seed=1, factor stability=1.000.
- `unrestricted_lam`: selected rank=5, seed=4, factor stability=1.000.
