# LAMCORE Unknown-State Program Discovery Report: GSE302356

> This report documents program-discovery candidates in GSE302356. It is not a completed independent-validation claim.

Run mode: `configured_full`. The configured full rank, seed, and donor-wise analysis parameters were used.

## Completed in this stage

- Input: 23759 cells and 38224 genes;
- Pools: high-confidence 2681, broad 8727, unrestricted guardrail 23759;
...
- `broad_lam_like`: selected rank=5, seed=0, factor stability=1.000.
- `unrestricted_lam`: selected rank=5, seed=0, factor stability=1.000.
