# LAM Research Hypothesis Card: high_confidence / program_5
...
`program_5` emerged in pooled NMF of the `high_confidence` candidate pool. Leading genes are: MALAT1, PLXDC2, ZEB2, FKBP5, MRC1, FMNL2, ASAP1, ACSL1, CHST11, SLC8A1, DOCK8, ELMO1.
...
Strongest known-program match: CORE3_identity (LAMCORE-specific; overlap=1). Partial overlap does not automatically invalidate a candidate; test whether it is a new LAMCORE implementation of a known state, has a LAM-specific component, or adds a new TF/regulon.
