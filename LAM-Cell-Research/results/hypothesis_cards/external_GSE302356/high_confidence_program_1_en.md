...
`program_1` emerged in pooled NMF of the `high_confidence` candidate pool. Leading genes are: MALAT1, SFTPC, ACOXL, SNX25, MAGI3, PTPN13, AFF3, PTPRK, MTUS1, ATP11A, CADPS2, RAPGEF5.
...
Strongest known-program match: IL6_AT2_repair (microenvironment; overlap=2). Partial overlap does not automatically invalidate a candidate; test whether it is a new LAMCORE implementation of a known state, has a LAM-specific component, or adds a new TF/regulon.
