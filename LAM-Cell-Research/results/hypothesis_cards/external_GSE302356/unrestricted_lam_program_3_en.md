# LAM Research Hypothesis Card: unrestricted_lam / program_3
...
`program_3` emerged in pooled NMF of the `unrestricted_lam` candidate pool. Leading genes are: MALAT1, FOS, CTSS, SMAP2, CEBPB, MNDA, RIPOR2, TYROBP, ACSL1, IL1R2, TXNIP, MCL1.
...
Strongest known-program match: macrophage_TREM2_TYROBP (microenvironment; overlap=3). Partial overlap does not automatically invalidate a candidate; test whether it is a new LAMCORE implementation of a known state, has a LAM-specific component, or adds a new TF/regulon.
