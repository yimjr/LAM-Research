...
`program_2` emerged in pooled NMF of the `broad_lam_like` candidate pool. Leading genes are: MALAT1, RPS8, RPL3, RPS3, RPS6, RPL5, TXNIP, H3F3B, SERF2, CD63, IGFBP7, LGALS1.

## Donor reproducibility

Donors meeting the current top-gene matching rule after donor-wise discovery: LAM32. This is independent donor discovery evidence, not passive scoring of a pooled model; an empty value means that cross-donor support is currently insufficient.
