# LAM Research Hypothesis Card: unrestricted_lam / program_1
...
`program_1` emerged in pooled NMF of the `unrestricted_lam` candidate pool. Leading genes are: MALAT1, SFTPC, ATP11A, SNX25, ACOXL, RBPMS, MICAL2, GPHN, MAGI3, CADM1, DIAPH2, MTUS1.
...
Strongest known-program match: IL6_AT2_repair (microenvironment; overlap=1). Partial overlap does not automatically invalidate a candidate; test whether it is a new LAMCORE implementation of a known state, has a LAM-specific component, or adds a new TF/regulon.
