...
`program_1` emerged in pooled NMF of the `unrestricted_lam` candidate pool. Leading genes are: TAF1D, JMJD1C, CARD11, DOCK8, COBLL1, ARAP2, PTMA, RB1, NPNT, FRY, DOCK2, TCF4.
