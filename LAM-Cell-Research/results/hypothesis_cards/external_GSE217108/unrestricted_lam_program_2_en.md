...
`program_2` emerged in pooled NMF of the `unrestricted_lam` candidate pool. Leading genes are: TAF1D, NCOA7, CDC42SE2, KLF12, MRC1, EIF4G3, GAB2, SLC11A1, LRBA, MAPK1, CAMK2D, MTRNR2L8.
...
Strongest known-program match: hypoxia_stress (LAM-shared; overlap=1). Partial overlap does not automatically invalidate a candidate; test whether it is a new LAMCORE implementation of a known state, has a LAM-specific component, or adds a new TF/regulon.
