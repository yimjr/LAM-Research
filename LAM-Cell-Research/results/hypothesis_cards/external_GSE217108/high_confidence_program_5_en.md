...
`program_5` emerged in pooled NMF of the `high_confidence` candidate pool. Leading genes are: KIF5B, PRKCB, PSAP, ATF7IP, XIST, LPP, YBX3, SECISBP2L, NCOA7, ADGRF5, SASH1, RAPGEF1.
