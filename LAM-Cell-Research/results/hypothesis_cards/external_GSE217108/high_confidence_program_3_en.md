...
`program_3` emerged in pooled NMF of the `high_confidence` candidate pool. Leading genes are: KIF5B, PELI1, PICALM, IKZF1, JMJD1C, HOXD11, FHIT, CEMIP2, MYH9, ZSWIM6, SRGN, ACOXL.
...
Strongest known-program match: TGFbeta_fibroblast (microenvironment; overlap=2). Partial overlap does not automatically invalidate a candidate; test whether it is a new LAMCORE implementation of a known state, has a LAM-specific component, or adds a new TF/regulon.
