# LAM Research Hypothesis Card: broad_lam_like / program_4
...
`program_4` emerged in pooled NMF of the `broad_lam_like` candidate pool. Leading genes are: MALAT1, SFTPC, MBNL1, SFTPA2, SFTPA1, ERBB4, BTBD9, ACOXL, ZBTB20, FOXP1, SECISBP2L, ATP1A1.
...
Strongest known-program match: IL6_AT2_repair (microenvironment; overlap=3). Partial overlap does not automatically invalidate a candidate; test whether it is a new LAMCORE implementation of a known state, has a LAM-specific component, or adds a new TF/regulon.
