...
`program_2` emerged in pooled NMF of the `broad_lam_like` candidate pool. Leading genes are: MALAT1, LAMA2, MACF1, ZBTB20, DST, FTX, LPP, A2M, PARD3B, RORA, TCF4, CARMIL1.
