...
`program_1` emerged in pooled NMF of the `high_confidence` candidate pool. Leading genes are: KIF5B, ARL15, MCTP1, CCDC141, TFDP2, SASH1, RBM47, PLEKHA1, AP3B1, DOCK5, MAP2K1, FAR1.
...
Strongest known-program match: lineage_uterine_smooth_muscle (lineage/reference; overlap=1). Partial overlap does not automatically invalidate a candidate; test whether it is a new LAMCORE implementation of a known state, has a LAM-specific component, or adds a new TF/regulon.
