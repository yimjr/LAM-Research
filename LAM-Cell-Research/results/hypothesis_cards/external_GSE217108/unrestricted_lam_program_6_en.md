# LAM Research Hypothesis Card: unrestricted_lam / program_6
...
`program_6` emerged in pooled NMF of the `unrestricted_lam` candidate pool. Leading genes are: TAF1D, HOXD11, HLA-A, HLA-E, MEF2A, TMSB10, LPP, ATP1A1, MYO9A, PELI1, LYN, RABGAP1L.
...
Strongest known-program match: HOX_PBX (LAM-shared; overlap=1). Partial overlap does not automatically invalidate a candidate; test whether it is a new LAMCORE implementation of a known state, has a LAM-specific component, or adds a new TF/regulon.
