...
`program_3` emerged in pooled NMF of the `broad_lam_like` candidate pool. Leading genes are: MALAT1, NHSL1, KCNMA1, FCHO2, CPM, SLC1A3, MSR1, MYO1E, CCDC88A, CTSB, FTX, RBM47.
...
Strongest known-program match: CORE2 (LAMCORE-specific; overlap=2). Partial overlap does not automatically invalidate a candidate; test whether it is a new LAMCORE implementation of a known state, has a LAM-specific component, or adds a new TF/regulon.
