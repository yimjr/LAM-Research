...
`program_3` emerged in pooled NMF of the `high_confidence` candidate pool. Leading genes are: MALAT1, IL32, PROM1, CCL14, CTSK, ARHGDIB, STK17A, DES, HSP90AB1, CDC37, CCL4L2, HSP90AA1.
...
Strongest known-program match: protease_ECM_niche (microenvironment; overlap=4). Partial overlap does not automatically invalidate a candidate; test whether it is a new LAMCORE implementation of a known state, has a LAM-specific component, or adds a new TF/regulon.
