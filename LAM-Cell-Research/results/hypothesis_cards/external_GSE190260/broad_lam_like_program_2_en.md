...
`program_2` emerged in pooled NMF of the `broad_lam_like` candidate pool. Leading genes are: ARHGDIB, NUPR1, TSPO, TMSB10, IGFBP7, ACTG1, ARF4, HLA-C, RPS8, TUBB4B, ATP5E, SERP1.
