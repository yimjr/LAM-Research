...
`program_5` emerged in pooled NMF of the `unrestricted_lam` candidate pool. Leading genes are: ARHGDIB, TMSB10, NUPR1, RPS3, ARF4, ATP5E, SLC2A3, SERP1, RPS8, TKT, SRRM1, SOD2.

## Donor reproducibility

Donors meeting the current top-gene matching rule after donor-wise discovery: LAM1164. This is independent donor discovery evidence, not passive scoring of a pooled model; an empty value means that cross-donor support is currently insufficient.
