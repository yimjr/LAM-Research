...
`program_5` emerged in pooled NMF of the `broad_lam_like` candidate pool. Leading genes are: FN1, ATP5E, C1QA, TMSB10, FIGF, SLC2A3, TYMS, LITAF, NUPR1, TKT, SERPINA1, RP11-290D2.6.

## Donor reproducibility

Donors meeting the current top-gene matching rule after donor-wise discovery: LAM1158. This is independent donor discovery evidence, not passive scoring of a pooled model; an empty value means that cross-donor support is currently insufficient.
