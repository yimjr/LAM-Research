# LAM Research Hypothesis Card：broad_lam_like / program_6
...
在 `broad_lam_like` 候选池的 pooled NMF 中出现了 `program_6`。当前排名靠前的基因为：ARHGDIB, NUPR1, TMSB10, RPS8, TKT, RPS3, SLC2A3, SERP1, ARF4, ATP5E, SRRM1, SEC61G。
