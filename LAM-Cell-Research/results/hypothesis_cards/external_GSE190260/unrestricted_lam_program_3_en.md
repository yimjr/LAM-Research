...
`program_3` emerged in pooled NMF of the `unrestricted_lam` candidate pool. Leading genes are: ESR1, SFTPA1, ARHGDIB, HOXA10, NUPR1, TKT, RPS3, RPS8, JUN, RPS6, RPLP0, PI16.
