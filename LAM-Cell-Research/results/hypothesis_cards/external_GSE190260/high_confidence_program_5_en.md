...
`program_5` emerged in pooled NMF of the `high_confidence` candidate pool. Leading genes are: HSP90AA1, STK17A, HLA-DQB1, CDC37, NFKBIA, RPLP0, SOD2, TREM2, RPS3, ARHGDIB, SIX1, EIF4B.
...
Strongest known-program match: HOX_PBX (LAM-shared; overlap=3). Partial overlap does not automatically invalidate a candidate; test whether it is a new LAMCORE implementation of a known state, has a LAM-specific component, or adds a new TF/regulon.
