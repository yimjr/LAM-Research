# LAM Research Hypothesis Card: broad_lam_like / program_1
...
`program_1` emerged in pooled NMF of the `broad_lam_like` candidate pool. Leading genes are: NUPR1, MYL9, TGFBR1, ATP5E, ACTA2, ARHGDIB, TPM2, LITAF, RPS8, HLA-E, RHOB, TKT.
...
Strongest known-program match: lineage_uterine_smooth_muscle (lineage/reference; overlap=4). Partial overlap does not automatically invalidate a candidate; test whether it is a new LAMCORE implementation of a known state, has a LAM-specific component, or adds a new TF/regulon.
