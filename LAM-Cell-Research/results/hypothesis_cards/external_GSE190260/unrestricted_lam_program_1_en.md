...
`program_1` emerged in pooled NMF of the `unrestricted_lam` candidate pool. Leading genes are: ARHGDIB, NUPR1, ATP5E, TMSB10, RPS8, ARF4, EZR, TKT, WFDC2, SERP1, LITAF, SLC2A3.
