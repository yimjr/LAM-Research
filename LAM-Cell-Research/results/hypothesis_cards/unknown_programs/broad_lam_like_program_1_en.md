...
`program_1` emerged in pooled NMF of the `broad_lam_like` candidate pool. Leading genes are: MLANA, AKT1, ELANE, MYH11, MMP9, VCAN, LGR5, TIMP1, HOXA10, PDGFRA, STAT4, KRT18.
