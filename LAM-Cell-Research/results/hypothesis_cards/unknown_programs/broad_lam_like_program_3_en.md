...
`program_3` emerged in pooled NMF of the `broad_lam_like` candidate pool. Leading genes are: C1QA, CXCL14, ADRB1, LST1, MDK, CD300LG, NES, NGFRAP1, MYH11, NDRG1, TIMP1, MMP9.
...
Strongest known-program match: IL6_AT2_repair (microenvironment; overlap=5). Partial overlap does not automatically invalidate a candidate; test whether it is a new LAMCORE implementation of a known state, has a LAM-specific component, or adds a new TF/regulon.
