...
`program_3` emerged in pooled NMF of the `unrestricted_lam` candidate pool. Leading genes are: MYH11, SFTPA1, HMGA2, CCL2, DES, TREM2, STAT1, RGS5, SFTPC, DHCR24, NES, JUN.
...
Strongest known-program match: macrophage_TREM2_TYROBP (microenvironment; overlap=4). Partial overlap does not automatically invalidate a candidate; test whether it is a new LAMCORE implementation of a known state, has a LAM-specific component, or adds a new TF/regulon.
