...
`program_1` emerged in pooled NMF of the `unrestricted_lam` candidate pool. Leading genes are: TREM2, AGR3, IL6, GPNMB, LCN2, EGFL6, SELL, MYH11, SFTPA1, HMGA2, CCL2, DES.
...
Strongest known-program match: IS_inflammatory (treatment-associated; overlap=3). Partial overlap does not automatically invalidate a candidate; test whether it is a new LAMCORE implementation of a known state, has a LAM-specific component, or adds a new TF/regulon.
