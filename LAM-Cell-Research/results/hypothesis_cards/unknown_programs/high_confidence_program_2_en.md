...
`program_2` emerged in pooled NMF of the `high_confidence` candidate pool. Leading genes are: GREB1, NFKBIA, ISG15, SFTPA1, COL3A1, IL6, KRT8, TMEM204, PCNA, COL6A1, GALNT18, CALD1.
