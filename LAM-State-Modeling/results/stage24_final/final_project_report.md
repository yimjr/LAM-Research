...
| 22 | State15 local branch decomposition | State15 周围哪些局部方向真正保留 LAM identity？ | State16/12/20/7 入选；State16 independent slope -0.023659、CORE3 -0.216772、null p=0.025948，标为 LAM_to_lineage_transition_candidate；其余三条为 ordinary_lineage_adjacency。 | 最终主线从“统一 manifold”收窄到“State15→State16 局部分支 candidate”。 | Stage23 仅可视化，不再改变该 checkpoint。 |
